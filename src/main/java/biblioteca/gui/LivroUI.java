...
public class LivroUI {
    ...
    private void cadastrarLivro() {
        ...
        novoLivro.setTitulo(promptInput.nextLine());
        ...
        // chamar o bibliotecaService com a função de listar as editoras
        // .getEditoras().forEach(editora -> editora.mostrarEditora());
        ...
        while (true) {
            ...
            try {
                ...
                if (editoraOpc.isPresent()) {
                    ...
                    System.out.printf(
                            "Editora selecionada: ID: %d | Nome: %s | CNPJ: %s | Endereço: %s | Telefone: %s | E-mail: %s%n",
                            editora.getId(), editora.getNome(), editora.getCnpj(), editora.getEndereco(),
                            editora.getTelefone(), editora.getEmail());
                    return editora;
                } else {
